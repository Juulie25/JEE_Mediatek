...
<head>
  <meta charset="utf-8">
  <title>Bienvenue √  la M√©diatek</title>
  <link rel="stylesheet" href="css/style.css">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous">
  <script src="script.js"></script>
</head>
<body>
    <h1 class="txt"><u>Bienvenue √  la M√©diatek</u></h1>
    <p class="txt">Pour acc√©der √  votre espace personnel, merci de vous connecter.</p>
    ...
    <p class="txt">La biblioth√®que M√©diatek vous acceuille du lundi au vendredi de 9h √  19h, et le samedi de 10h √  17h.</p>
</body>
</html>