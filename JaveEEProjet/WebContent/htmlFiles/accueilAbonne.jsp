...
<%
	...
	List<Document> documentsAEmprunter = Mediatheque.getInstance().tousLesDocumentsDisponibles();
%>
<!doctype html>
<html lang="fr">
    <head>
            ...
            <div class="container">
                ...
                <table id="listeDocs">  
                    ...
                    <% for(int i = 0; i < documentsAEmprunter.size(); i++){ %> 
						<tr><th><%=documentsAEmprunter.get(i).getType() %></th><th><%=documentsAEmprunter.get(i).getTitre() %></th><th><%= documentsAEmprunter.get(i).getAuteur()%></th><td><button type="button" class="btn btn-primary">Emprunter</button></td></tr>
					<%}%> 
                </table>
           </div>
           <div class="container">
